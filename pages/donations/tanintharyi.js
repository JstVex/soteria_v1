    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <p className={styles.title}>Tanintharyi</p>
            </div>
...
export async function getServerSideProps() {
    const res = await fetch(`https://soteria-backend-alc9.onrender.com/donations/tanintharyi`)
